            ...
            <c:if test="${not empty usuarioLogeado }" >
	            	<li class="dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
				          <a class="dropdown-item" href="seguridad/productos?accion=listar">Tabla Productos</a>
				          <a class="dropdown-item" href="seguridad/productos?accion=formulario&id=0">Nuevo Producto</a>
				        </div>
				    </li>
				    <li class="dropdown">
				        ...
				        <ul class="dropdown-menu">
				          <li><a class="dropdown-item" href="seguridad/usuarios?accion=listar">Tabla Usuarios</a></li>
				          <li><a class="dropdown-item" href="seguridad/usuarios?accion=formulario&id=0">Nuevo Usuario</a></li>
				        </ul>
				     </li>
					<li>
				     	<a class="py-2 d-none d-md-inline-block" href="logout" style="list-style: none;">Cerrar Sessión</a>
				    </li>
